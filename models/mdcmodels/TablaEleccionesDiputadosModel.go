...
type TablaEleccionesDiputadosModel struct {
...
func (tablaEleccionesDiputados TablaEleccionesDiputadosModel) TableName() string {
	return "TABLA_ELECCIONES_DIPUTADOS_MODEL"
}
