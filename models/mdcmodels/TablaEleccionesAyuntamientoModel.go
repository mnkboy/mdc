...
type TablaEleccionesAyuntamientoModel struct {
...
func (tablaEleccionesAyuntamientoModel TablaEleccionesAyuntamientoModel) TableName() string {
	return "TABLA_ELECCIONES_AYUNTAMIENTO_MODEL"
}
