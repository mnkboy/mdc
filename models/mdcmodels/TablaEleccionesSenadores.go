...
type TablaEleccionesSenadoresModel struct {
...
func (tablaEleccionesSenadores TablaEleccionesSenadoresModel) TableName() string {
	return "TABLA_ELECCIONES_SENADORES"
}
